...
*Created <date>. Read this first.*

## The one-sentence pitch
<classic mechanic + the single innovation, in one line>
...
- The tutorial in one sentence: <…>
- What we are explicitly NOT adding (budget guard): <…>
